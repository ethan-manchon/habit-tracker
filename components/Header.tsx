...
export default function Header({ title = "Mes Routines" }: { title?: string }) {
  return (
    <header className="w-full max-w-2xl mx-auto pt-8 pb-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button className="text-sm text-gray-400 px-3 py-1 rounded-full bg-gray-800/60">Série actuelle</button>
